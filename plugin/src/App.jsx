  ...
  return (
    <>
      <div className="container">
        ...
        <br />
        <p>
          Once the conversion is complete, you can easily copy the transcribed
          text and share it with others. Whether it's for collaboration,
          note-taking, or preserving important conversations, this app has got
          you covered!
        </p>
