  ...
  return (
    <>
      <main
        ...
        style={{
          backgroundImage: `url('https://images8.alphacoders.com/127/1275714.jpg')`,
          backgroundSize: "cover",
        }}
      >
        <div className="container mx-auto px-4 h-full">
          <p className="text-7xl font-medium text-sky-400">Welcome Back</p>
          <p className="pt-4 text-4xl text-white">Login to your account</p>
          <div className="w-full flex justify-end">
            <div className="w-full lg:w-4/12 px-4">
              <div className=" flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-300 border-0">
                <div className="rounded-t mb-0 px-6 py-6 text-center text-lg font-bold text-gray-700"></div>
